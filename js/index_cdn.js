...
D.ready(function(){
	...
	//upload photo
	var photolayer=$("#photolayer").css("background-image","url('http://image.gis-ad.com/img/step1.jpg')");
	...
	$(".frontbg",completelayer).css("background-image","url('http://image.gis-ad.com/img/completec.png')");
	...
	$("#slide_01 .mod_01").each(function(i,v){
		v=$(v);
		$("img",v).attr("src","http://image.gis-ad.com/img/"+(i+1)+".png");
	});
...
function onBridgeReady() {
		var appId  = '',
        imgUrl = htmlDecode("http://image.gis-ad.com/img/wechat.jpg"),
