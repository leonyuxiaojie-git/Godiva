...
D.ready(function(){
	...
	function resetcustomlayer(){
		...
		if(ispad){
			$("#panel_b").css("background-image","url('images/pano_b.jpg')");
		}else{
			$("#panel_b").css("background-image","url('images/pano_bs.jpg')");
		}
	...
	$("#loadingcon .loadingtip").css({"width":THISW*0.4,"height":THISW*0.4,"top":(THISH-THISW*0.6)/2,"left":(THISW-THISW*0.4)/2});
   	...
   	var loadimgs=[
   		{"url":"img/loadingbg1.jpg"},
   		{"url":"img/loadingtext1.png"},
   		{"url":"img/tip_1.gif"},
   		{"url":"img/tip_2.gif"},
   		{"url":ispad?"images/pano_b.jpg":"images/pano_bs.jpg"},
   		{"url":ispad?"images/pano_f.jpg":"images/pano_fs.jpg"},
   		{"url":ispad?"images/pano_l.jpg":"images/pano_ls.jpg"},
   		{"url":ispad?"images/pano_r.jpg":"images/pano_rs.jpg"},
   		{"url":ispad?"images/pano_u.jpg":"images/pano_us.jpg"},
   		{"url":ispad?"images/pano_d.jpg":"images/pano_ds.jpg"}
   	];
   	if(location.href.indexOf("GODVIA")>0){
   		loadimgs=[
	   		{"url":"img/loadingbg2.jpg"},
	   		{"url":"img/loadingtext2.png"},
	   		{"url":"img/tip_1.gif"},
	   		{"url":"img/tip_2.gif"},
	   		{"url":ispad?"images/pano_b.jpg":"images/pano_bs.jpg"},
	   		{"url":ispad?"images/pano_f.jpg":"images/pano_fs.jpg"},
   		...
   		if(param && param.indexOf("GODVIA")>=0 ){
						  ...
						  success: function(data){
						  	if(data && data.err==0){
						  		...
						  		if(_ttxt!="Dear Friends"){
						  			if(_ttxt.length>9){
										_ttxt=_ttxt.substr(0,8);
									}
						  		}	
								var _ctxt=$("#TextContent").val();
								if(_ctxt.length>10){
									_ctxt=_ctxt.substr(0,9);
								}
								var _ftxt=$("#TextFrom").val();
								if(_ftxt.length>9){
									_ftxt=_ftxt.substr(0,8);
								}
   			...
   			(function __(){
   				if(curper>=loadimgs[3].per){
   					...
   					$("#loadingcon .bg").css("background-image","url('img/loadingbg2.jpg')");
   					$("#loadingcon .textbg").css("background-image","url('img/loadingtext2.png')");
   					_begin();
   			...
   			(function __(){
   				if(curper>=loadimgs[3].per){
   					$("#loadingcon .loadingbg").remove();
   					$("#loadingcon .bg").css("background-image","url('img/loadingbg1.jpg')");
   					$("#loadingcon .textbg").css("background-image","url('img/loadingtext1.png')");
   					_begin();
   				}else{
   					setTimeout(__,100);
   				}
   				...
   				$(".slidercursor").css({"opacity":0}).show().animate({"opacity":1},function(){
					$(".slidercursor").bind("touchmove",function(e){
							...
							if(touches.length==2){
								...
								//$("#loadingcon .textbg").css("background-image","url('img/cover.jpg')");
    	...
    	if(crnum<curper){
    		...
    		if(crnum==50){
    			...
    			tar.stop().show().animate({"opacity":0},500,function(){
    				tar.css("background-image","url('img/tip_2.gif')").animate({"opacity":1});
    			});
    		}
    		if(crnum==curper){
    			if(crnum<100){
    				...
    				if(loadinghandler){
						...
						orientationevent();
						setTimeout(function(){
							$("#panel_f").css("background-image",ispad?"url('images/pano_f.jpg')":"url('images/pano_fs.jpg')");
	    					$("#panel_b").css("background-image",ispad?"url('images/pano_b.jpg')":"url('images/pano_bs.jpg')");
	    					$("#panel_l").css("background-image",ispad?"url('images/pano_l.jpg')":"url('images/pano_ls.jpg')");
	    					$("#panel_r").css("background-image",ispad?"url('images/pano_r.jpg')":"url('images/pano_rs.jpg')");
	    					$("#panel_u").css("background-image",ispad?"url('images/pano_u.jpg')":"url('images/pano_us.jpg')");
	    					$("#panel_d").css("background-image",ispad?"url('images/pano_d.jpg')":"url('images/pano_ds.jpg')");
							D.data("pano",true);
							
							
							
							$("#plugincon").append($("#hs_0").bind("tapone",function(){$("#productslayer").show()}));
							$("#plugincon").append($("#hs_2").bind("tapone",function(){$("#couponcon").show()}));
							$("#plugincon").append($("#hs_1").bind("tapone",function(){
								$("#onuploading").show();
								$("#onuploading span").hide();
								var _count=0;
								var _imgs=[
									{"url":ispad?"images/inner_f.jpg":"images/inner_fs.jpg"},
									{"url":ispad?"images/inner_b.jpg":"images/inner_bs.jpg"},
									{"url":ispad?"images/inner_l.jpg":"images/inner_ls.jpg"},
									{"url":ispad?"images/inner_r.jpg":"images/inner_rs.jpg"},
									{"url":ispad?"images/inner_u.jpg":"images/inner_us.jpg"},
									{"url":ispad?"images/inner_d.jpg":"images/inner_ds.jpg"}
								]
								...
								function __(){
									if(_count>=5){
										...
										$("#pano").stop().animate({"opacity":0},1000,function(){
											...
											$("#hs_1").hide();
											$("#plugincon").hide();
											$("img",$("#panel_f").css("background-image",ispad?"url('images/inner_f.jpg')":"url('images/inner_fs.jpg')")).hide();
											$("img",$("#panel_b").css("background-image",ispad?"url('images/inner_b.jpg')":"url('images/inner_bs.jpg')")).hide();
											$("img",$("#panel_l").css("background-image",ispad?"url('images/inner_l.jpg')":"url('images/inner_ls.jpg')")).hide();
											$("img",$("#panel_r").css("background-image",ispad?"url('images/inner_r.jpg')":"url('images/inner_rs.jpg')")).hide();
											$("img",$("#panel_u").css("background-image",ispad?"url('images/inner_u.jpg')":"url('images/inner_us.jpg')")).hide();
											$("img",$("#panel_d").css("background-image",ispad?"url('images/inner_d.jpg')":"url('images/inner_ds.jpg')")).hide();
											scencetar.view.hlookat=160;
											
											$("#pano").animate({"opacity":1},1000,function(){
												$("<img class=\"returnbtn\" src=\"img/returnbtn.png\" />").bind("tapone",function(){
													$("#pano").stop().animate({"opacity":0},1000,function(){
														$("img",$("#panel_f").css("background-image",ispad?"url('images/pano_f.jpg')":"url('images/pano_fs.jpg')")).show();
														if(customparam.card){
															$("img",$("#panel_b").css("background-image",ispad?"url('images/pano_btxt.jpg')":"url('images/pano_btxts.jpg')")).show();
														}else{
															$("img",$("#panel_b").css("background-image",ispad?"url('images/pano_b.jpg')":"url('images/pano_bs.jpg')")).show();
														}
								    					
								    					$("img",$("#panel_l").css("background-image",ispad?"url('images/pano_l.jpg')":"url('images/pano_ls.jpg')")).show();
								    					$("img",$("#panel_r").css("background-image",ispad?"url('images/pano_r.jpg')":"url('images/pano_rs.jpg')")).show();
								    					$("img",$("#panel_u").css("background-image",ispad?"url('images/pano_u.jpg')":"url('images/pano_us.jpg')")).show();
								    					$("img",$("#panel_d").css("background-image",ispad?"url('images/pano_d.jpg')":"url('images/pano_ds.jpg')")).show();
    ...
    $("<img src=\"img/info.png\"/>").load(function(){
	...
	function scrollnews(){
		...
		var img=$("<img src=\"img/transparent.png\"/>");
		img.load(function(){
	...
	//share
	$("#sharelayer").bind("touchmove",function(e){e.preventDefault();});
	...
	$("#sharelayer .sinabtn").bind("tapone",function(e){
		...
		_url+=("&pic="+encodeURI(snsparam.img));//"&pic=http://vw.faw-vw.com/images/vwlogo.png";
	...
	$("#sharelayer .qzonebtn").bind("tapone",function(e){
		...
		_url+=("url="+encodeURI(snsparam.link));
		_url+=("&summary="+encodeURI(snsparam.title));
	...
	//upload photo
	var photolayer=$("#photolayer").css("background-image","url('imgs/step1.jpg')");
	...
	function resetuploadphoto(){
		...
		$("#selectphoto").unbind("load").attr("src","img/transparent.png");
	...
	function lpnextstep(){
		...
		var panelsize=640;
		var panelurl="images/pano_ls.jpg";
		if(appver.indexOf("ipad")>0){
			panelsize=1080;
			panelurl="images/pano_l.jpg";
		}
	...
	$("#selectfile").change(function(e){
		$("#onprocessing").show();
		$("#selectphoto").attr("src","img/transparent.png");
	     ...
	     try{
	       ...
	       reader.onload = (function(theFile) {
	         return function(e){               
	          imgtar.unbind("swipemove").unbind().removeAttr("style").attr("src","img/transparent.png").load(function(){
	          	...
	          	imgtar.data("p",_para).bind("tapone",function(){
					...
					//$("#selectfile")[0].click();
				})/*.bind("pinch",function(e,p){
					var _p=imgtar.data("p");
					if(_p.height){
						var osize=_p.starth;
						osize*=p.scale;
						if(osize<=2*_p.height && osize>=_p.height){
							_p.starth=osize;
							imgtar.height(osize).width(osize*thisr);
							centeralimg(imgtar);
						}
					}else{
						var osize=_p.startw;
						osize*=p.scale;
						if(osize<=2*_p.width && osize>=_p.width){
							_p.startw=osize;
							imgtar.width(osize).height(osize/thisr);
							centeralimg(imgtar);
						}
					}
					imgtar.data("p",_p);
	 	...
	 	$("#selectfile").localResizeIMG({
             ...
             success: function (result) {
             	$("#onprocessing").show();
             	imgtar.unbind("swipemove").unbind().removeAttr("style").attr("src",result.base64).load(function(){
	 ...
	 function makemessage(txtparam){
	 	var con=$("#panel_b");
        var  param={"url":"images/pano_btxts.jpg?a=1","size":640,"w":318,"top":99}
        if(appver.indexOf("ipad")>0){
			 param={"url":"images/pano_btxt.jpg?a=2","size":1080,"w":540,"top":168}
		}
       	$("img",con).remove();
        var cv=document.createElement("canvas");
        var ctx=cv.getContext("2d");
        ...
        $("<img  src=\"img/transparent.png\"  />").load(function(){
        	ctx.drawImage(this,0,0,this.width,this.height,0,0,con.width(),con.height());
        	$("<img  src=\"img/messagebg.png\"  />").load(function(){
        		con.css("background-image","url('"+param.url+"')")
	        	var _w=(param.w/param.size)*con.width();
	        	var _h=(this.height/this.width)*_w;
	        	ctx.drawImage(this,0,0,this.width,this.height,0.292*con.width(),(param.top/param.size)*con.height(),_w,_h);
		        ...
		        //var mw=textctx.measureText(txtparam.t1);
				ctx.fillText(("To:"+txtparam.t1),0.39*con.width(),(0.1718*con.height()+10));
				
				ctx.font="italic bold 0.8em serif";
		        ctx.fillStyle="#efda95";
		        //textctx.textAlign="center";
		        //var mw=textctx.measureText(txtparam.t2);
				ctx.fillText(txtparam.t2,0.39*con.width(),(0.2281*con.height()+12));
				
				ctx.font="italic bold 0.8em serif";
		        ctx.fillStyle="#efda95";
		        //textctx.textAlign="center";
		        //var mw=textctx.measureText(txtparam.t3);
				ctx.fillText(("From:"+txtparam.t3),0.39*con.width(),(0.3*con.height()+10));
	...
	treelayer.css("background-image","url('img/step3.jpg')");
	$(".returnbtn",treelayer).bind("tapone",function(){
		$("#maincontent").show();
		$("#photolayer").css("opacity",1).hide();
		resetuploadphoto();
		$("#cardlayer").css("opacity",1).hide();
	...
	$(".returncomplete .completebtn",treelayer).bind("tapone",function(){
		...
		if(gifts.length){
			var para={"url":"images/pano_fs.jpg","size":640,"w":295,"h":323,"l":177,"t":206};
			if(appver.indexOf("ipad")>0){
				para={"url":"images/pano_f.jpg","size":1080,"w":440,"h":510,"l":326,"t":348};
			}
			...
			$(".giftcon",treelayer).each(function(i,v){
				...
				$("<img src=\""+v.attr("src")+"\"/>").load(function(){
	...
	function getFont(message){
		...
		if(customparam.card){
			...
			$("#SpanContent").text(_ctxt);
			$("#SpanFrom").text("From:"+_ftxt);
			$(".completecard").css("background-image","url('img/card.png')")
			makemessage({"t1":_ttxt,"t2":_ctxt,"t3":_ftxt});
		}else{
			$("#SpanTo").text("");
			$("#SpanContent").text("");
			$("#SpanFrom").text("");
			$(".completecard").css("background-image","url('img/carddefault.png')");
		}
	}
	
	//complete
	var completelayer=$("#completelayer");
	$(".frontbg",completelayer).css("background-image","url('../imgs/completec.png')");
	...
	$(".preview",completelayer).bind("tapone",function(){
		...
		$("#hs_1").hide();
		$("#hs_2").hide();
		$("<img id=\"prereturn\" src=\"img/prereturn.png\" />").bind("tapone",function(){
			$("#hs_0").show();
			$("#hs_1").show();
			$("#hs_2").show();
			$(this).remove();
...
var snsparam={
	"img":"http://121.41.115.23/img/sns.jpg",
	"link":location.href.split("?")[0],
	"title":"2014GODIVA＃歌帝梵冬日仙境＃。",
	"desc":"t歌帝梵推出圣诞限量巧克力礼盒，360°转动手机制作你的专属圣诞贺卡，即刻获赠10元礼惠！拿起手机扫码或直接点击进入体验：http://www.godiva.cn/ultimate2014"
}
