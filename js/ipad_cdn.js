...
D.ready(function(){
	...
	$("#loadingcon .loadingtip").css({"width":THISW*0.4,"height":THISW*0.4,"top":(THISH-THISW*0.6)/2,"left":(THISW-THISW*0.4)/2});
   	...
   	var loadimgs=[
   		{"url":"http://image.gis-ad.com/imgpad/loadingbg1.jpg"},
   		{"url":"http://image.gis-ad.com/imgpad/loadingtext1.png"},
   		{"url":"http://image.gis-ad.com/imgpad/tip_1.gif"},
   		{"url":"http://image.gis-ad.com/imgpad/tip_2.gif"},
   		{"url":"http://image.gis-ad.com/images/pano_bs.jpg"},
   		{"url":"http://image.gis-ad.com/images/pano_fs.jpg"},
   		{"url":"http://image.gis-ad.com/images/pano_ls.jpg"},
   		{"url":"http://image.gis-ad.com/images/pano_rs.jpg"},
   		{"url":"http://image.gis-ad.com/images/pano_us.jpg"},
   		{"url":"http://image.gis-ad.com/images/pano_ds.jpg"}
   	];
   	if(location.href.indexOf("GODVIA")>0){
   		loadimgs=[
	   		{"url":"http://image.gis-ad.com/imgpad/loadingbg2.jpg"},
	   		{"url":"http://image.gis-ad.com/imgpad/loadingtext2.png"},
	   		{"url":"http://image.gis-ad.com/imgpad/tip_1.gif"},
	   		{"url":"http://image.gis-ad.com/imgpad/tip_2.gif"},
	   		{"url":"http://image.gis-ad.com/images/pano_bs.jpg"},
	   		{"url":"http://image.gis-ad.com/images/pano_fs.jpg"},
    ...
    (function(){
    	...
    	$("<img src=\"http://image.gis-ad.com/imgpad/transparent.png\"/>").load(function(){
    		var tar=$(this);
    		crindex++;
    		if(crindex==0){
    			//invokedraw();
   		...
   		if(param && param.indexOf("GODVIA")>=0 ){
   			...
   			(function __(){
   				if(curper>=loadimgs[3].per){
   					...
   					$("#loadingcon .bg").css("background-image","url('http://image.gis-ad.com/imgpad/loadingbg2.jpg')");
   					$("#loadingcon .textbg").css("background-image","url('http://image.gis-ad.com/imgpad/loadingtext2.png')");
   					_begin();
   			...
   			(function __(){
   				if(curper>=loadimgs[3].per){
   					$("#loadingcon .loadingbg").remove();
   					$("#loadingcon .bg").css("background-image","url('http://image.gis-ad.com/imgpad/loadingbg1.jpg')");
   					$("#loadingcon .textbg").css("background-image","url('http://image.gis-ad.com/imgpad/loadingtext1.png')");
   					_begin();
   				}else{
   					setTimeout(__,100);
   				}
   				...
   				$(".slidercursor").css({"opacity":0}).show().animate({"opacity":1},function(){
					$(".slidercursor").bind("touchmove",function(e){
							...
							if(touches.length==2){
								...
								//$("#loadingcon .textbg").css("background-image","url('http://image.gis-ad.com/imgpad/cover.jpg')");
    	...
    	if(crnum<curper){
    		...
    		if(crnum==50){
    			...
    			tar.stop().show().animate({"opacity":0},500,function(){
    				tar.css("background-image","url('http://image.gis-ad.com/imgpad/tip_2.gif')").animate({"opacity":1});
    			});
    		}
    		if(crnum==curper){
    			if(crnum<100){
    				...
    				if(loadinghandler){
						...
						orientationevent();
						setTimeout(function(){
							$("#panel_f").css("background-image","url('http://image.gis-ad.com/images/pano_fs.jpg')");
	    					$("#panel_b").css("background-image","url('http://image.gis-ad.com/images/pano_bs.jpg')");
	    					$("#panel_l").css("background-image","url('http://image.gis-ad.com/images/pano_ls.jpg')");
	    					$("#panel_r").css("background-image","url('http://image.gis-ad.com/images/pano_rs.jpg')");
	    					$("#panel_u").css("background-image","url('http://image.gis-ad.com/images/pano_us.jpg')");
	    					$("#panel_d").css("background-image","url('http://image.gis-ad.com/images/pano_ds.jpg')");
							D.data("pano",true);
							...
							$("#plugincon").append($("#hs_1").bind("tapone",function(){
								...
								var _count=0;
								var _imgs=[
									{"url":"http://image.gis-ad.com/images/inner_fs.jpg"},
									{"url":"http://image.gis-ad.com/images/inner_bs.jpg"},
									{"url":"http://image.gis-ad.com/images/inner_ls.jpg"},
									{"url":"http://image.gis-ad.com/images/inner_rs.jpg"},
									{"url":"http://image.gis-ad.com/images/inner_us.jpg"},
									{"url":"http://image.gis-ad.com/images/inner_ds.jpg"}
								]
								...
								function __(){
									if(_count>=5){
										...
										$("#pano").stop().animate({"opacity":0},1000,function(){
											...
											$("#hs_1").hide();
											$("#plugincon").hide();
											$("img",$("#panel_f").css("background-image","url('http://image.gis-ad.com/images/inner_fs.jpg')")).hide();
											$("img",$("#panel_b").css("background-image","url('http://image.gis-ad.com/images/inner_bs.jpg')")).hide();
											$("img",$("#panel_l").css("background-image","url('http://image.gis-ad.com/images/inner_ls.jpg')")).hide();
											$("img",$("#panel_r").css("background-image","url('http://image.gis-ad.com/images/inner_rs.jpg')")).hide();
											$("img",$("#panel_u").css("background-image","url('http://image.gis-ad.com/images/inner_us.jpg')")).hide();
											$("img",$("#panel_d").css("background-image","url('http://image.gis-ad.com/images/inner_ds.jpg')")).hide();
											scencetar.view.hlookat=160;
											
											$("#pano").animate({"opacity":1},1000,function(){
												$("<img class=\"returnbtn\" src=\"http://image.gis-ad.com/imgpad/returnbtn.png\" />").bind("tapone",function(){
													$("#pano").stop().animate({"opacity":0},1000,function(){
														$("img",$("#panel_f").css("background-image","url('http://image.gis-ad.com/images/pano_fs.jpg')")).show();
														if(customparam.card){
															$("img",$("#panel_b").css("background-image","url('http://image.gis-ad.com/images/pano_btxts.jpg')")).show();
														}else{
															$("img",$("#panel_b").css("background-image","url('http://image.gis-ad.com/images/pano_bs.jpg')")).show();
														}
								    					
								    					$("img",$("#panel_l").css("background-image","url('http://image.gis-ad.com/images/pano_ls.jpg')")).show();
								    					$("img",$("#panel_r").css("background-image","url('http://image.gis-ad.com/images/pano_rs.jpg')")).show();
								    					$("img",$("#panel_u").css("background-image","url('http://image.gis-ad.com/images/pano_us.jpg')")).show();
								    					$("img",$("#panel_d").css("background-image","url('http://image.gis-ad.com/images/pano_ds.jpg')")).show();
    ...
    $("<img src=\"http://image.gis-ad.com/imgpad/info.png\"/>").load(function(){
	...
	function scrollnews(){
		...
		var img=$("<img src=\"http://image.gis-ad.com/imgpad/transparent.png\"/>");
		img.load(function(){
		...
		}).attr("src","http://image.gis-ad.com/imgpad/products.png");
	}
	...
	//upload photo
	var photolayer=$("#photolayer").css("background-image","url('http://image.gis-ad.com/imgpad/step1.jpg')");
	...
	function resetuploadphoto(){
		...
		$("#selectphoto").unbind("load").attr("src","http://image.gis-ad.com/imgpad/transparent.png");
	...
	treelayer.css("background-image","url('http://image.gis-ad.com/imgpad/step3.jpg')");
	...
	function getFont(message){
		...
		if(customparam.card){
			...
			$("#SpanContent").text(_ctxt);
			$("#SpanFrom").text("From:"+_ftxt);
			$(".completecard").css("background-image","url('http://image.gis-ad.com/imgpad/card.png')")
			makemessage({"t1":_ttxt,"t2":_ctxt,"t3":_ftxt});
		}else{
			$("#SpanTo").text("");
			$("#SpanContent").text("");
			$("#SpanFrom").text("");
			$(".completecard").css("background-image","url('http://image.gis-ad.com/imgpad/carddefault.png')");
		}
	}
	...
	$(".preview",completelayer).bind("tapone",function(){
		...
		$("#hs_1").hide();
		$("#hs_2").hide();
		$("<img id=\"prereturn\" src=\"http://image.gis-ad.com/imgpad/prereturn.png\" />").bind("tapone",function(){
			$("#hs_0").show();
			$("#hs_1").show();
			$("#hs_2").show();
			$(this).remove();
	...
	$("#slide_01 .mod_01").each(function(i,v){
		v=$(v);
		$("img",v).attr("src","http://image.gis-ad.com/imgpad/"+(i+1)+".png");
	});
...
var snsparam={
	"img":"http://image.gis-ad.com/imgpad/sns.jpg",
