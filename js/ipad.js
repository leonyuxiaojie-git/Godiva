...
D.ready(function(){
	...
	$("#caminfolink").css("top",THISW*900/700*0.9-(THISW*900/700-THISH)/2).bind("tapone",function(){
		$("#campaigninfo").show();
	})
	$("#loadingcon .loadingtip").css({"width":THISW*0.4,"height":THISW*0.4,"top":(THISH-THISW*0.6)/2,"left":(THISW-THISW*0.4)/2});
   	...
   	var loadimgs=[
   		{"url":"imgpad/loadingbg1.jpg"},
   		{"url":"imgpad/loadingtext1.png"},
   		{"url":"imgpad/tip_1.gif"},
   		{"url":"imgpad/tip_2.gif"},
   		{"url":"images/pano_bs.jpg"},
   		{"url":"images/pano_fs.jpg"},
   		{"url":"images/pano_ls.jpg"},
   		{"url":"images/pano_rs.jpg"},
   		{"url":"images/pano_us.jpg"},
   		{"url":"images/pano_ds.jpg"}
   	];
   	if(location.href.indexOf("GODVIA")>0){
   		loadimgs=[
	   		{"url":"imgpad/loadingbg2.jpg"},
	   		{"url":"imgpad/loadingtext2.png"},
	   		{"url":"imgpad/tip_1.gif"},
	   		{"url":"imgpad/tip_2.gif"},
	   		{"url":"images/pano_bs.jpg"},
	   		{"url":"images/pano_fs.jpg"},
    ...
    (function(){
    	...
    	$("<img src=\"imgpad/transparent.png\"/>").load(function(){
    		var tar=$(this);
    		crindex++;
    		if(crindex==0){
    			//invokedraw();
   		...
   		if(param && param.indexOf("GODVIA")>=0 ){
   			...
   			(function __(){
   				if(curper>=loadimgs[3].per){
   					...
   					$("#loadingcon .bg").css("background-image","url('imgpad/loadingbg2.jpg')");
   					$("#loadingcon .textbg").css("background-image","url('imgpad/loadingtext2.png')");
   					_begin();
   			...
   			(function __(){
   				if(curper>=loadimgs[3].per){
   					$("#loadingcon .loadingbg").remove();
   					$("#loadingcon .bg").css("background-image","url('imgpad/loadingbg1.jpg')");
   					$("#loadingcon .textbg").css("background-image","url('imgpad/loadingtext1.png')");
   					_begin();
   				}else{
   					setTimeout(__,100);
   				}
   				...
   				$(".slidercursor").css({"opacity":0}).show().animate({"opacity":1},function(){
					$(".slidercursor").bind("touchmove",function(e){
							...
							if(touches.length==2){
								...
								//$("#loadingcon .textbg").css("background-image","url('imgpad/cover.jpg')");
    	...
    	if(crnum<curper){
    		...
    		if(crnum==50){
    			...
    			tar.stop().show().animate({"opacity":0},500,function(){
    				tar.css("background-image","url('imgpad/tip_2.gif')").animate({"opacity":1});
    			});
    		}
    		if(crnum==curper){
    			if(crnum<100){
    				...
    				if(loadinghandler){
						...
						orientationevent();
						setTimeout(function(){
							$("#panel_f").css("background-image","url('images/pano_fs.jpg')");
	    					$("#panel_b").css("background-image","url('images/pano_bs.jpg')");
	    					$("#panel_l").css("background-image","url('images/pano_ls.jpg')");
	    					$("#panel_r").css("background-image","url('images/pano_rs.jpg')");
	    					$("#panel_u").css("background-image","url('images/pano_us.jpg')");
	    					$("#panel_d").css("background-image","url('images/pano_ds.jpg')");
							D.data("pano",true);
							...
							$("#plugincon").append($("#hs_1").bind("tapone",function(){
								...
								var _count=0;
								var _imgs=[
									{"url":"images/inner_fs.jpg"},
									{"url":"images/inner_bs.jpg"},
									{"url":"images/inner_ls.jpg"},
									{"url":"images/inner_rs.jpg"},
									{"url":"images/inner_us.jpg"},
									{"url":"images/inner_ds.jpg"}
								]
								...
								function __(){
									if(_count>=5){
										...
										$("#pano").stop().animate({"opacity":0},1000,function(){
											...
											$("#hs_1").hide();
											$("#plugincon").hide();
											$("img",$("#panel_f").css("background-image","url('images/inner_fs.jpg')")).hide();
											$("img",$("#panel_b").css("background-image","url('images/inner_bs.jpg')")).hide();
											$("img",$("#panel_l").css("background-image","url('images/inner_ls.jpg')")).hide();
											$("img",$("#panel_r").css("background-image","url('images/inner_rs.jpg')")).hide();
											$("img",$("#panel_u").css("background-image","url('images/inner_us.jpg')")).hide();
											$("img",$("#panel_d").css("background-image","url('images/inner_ds.jpg')")).hide();
											scencetar.view.hlookat=160;
											
											$("#pano").animate({"opacity":1},1000,function(){
												$("<img class=\"returnbtn\" src=\"imgpad/returnbtn.png\" />").bind("tapone",function(){
													$("#pano").stop().animate({"opacity":0},1000,function(){
														$("img",$("#panel_f").css("background-image","url('images/pano_fs.jpg')")).show();
														if(customparam.card){
															$("img",$("#panel_b").css("background-image","url('images/pano_btxts.jpg')")).show();
														}else{
															$("img",$("#panel_b").css("background-image","url('images/pano_bs.jpg')")).show();
														}
								    					
								    					$("img",$("#panel_l").css("background-image","url('images/pano_ls.jpg')")).show();
								    					$("img",$("#panel_r").css("background-image","url('images/pano_rs.jpg')")).show();
								    					$("img",$("#panel_u").css("background-image","url('images/pano_us.jpg')")).show();
								    					$("img",$("#panel_d").css("background-image","url('images/pano_ds.jpg')")).show();
    ...
    $("<img src=\"imgpad/info.png\"/>").load(function(){
	...
	function scrollnews(){
		...
		var img=$("<img src=\"imgpad/transparent.png\"/>");
		img.load(function(){
			...
			var _a1=$("<a target=\"_blank\" href=\"http://detail.tmall.com/item.htm?spm=a1z10.1.w5003-8326959381.11.skBhZ0&id=42282291309&scene=taobao_shop\" style=\"position:absolute;left:0;top:0;width:100%;height:22.75%;\"></a>").click(function(){
				_pt_sp_2.push('setTrackEvent,Goumai,Click,shengdanxianliang,0');
			});
			var _a2=$("<a target=\"_blank\" href=\"http://detail.tmall.com/item.htm?spm=a1z10.1.w5003-8315276373.10.skBhZ0&id=42343561625&scene=taobao_shop\" style=\"position:absolute;left:0;top:22.57%;width:100%;height:24.57%;\"></a>").click(function(){
				_pt_sp_2.push('setTrackEvent,Goumai,Click,shengdansongluxing,0');
			});
			var _a3=$("<a target=\"_blank\" href=\"http://detail.tmall.com/item.htm?spm=a1z10.1.w5003-8315278706.10.skBhZ0&id=18378604740&scene=taobao_shop\" style=\"position:absolute;left:0;top:47.32%;width:100%;height:26.5%;\"></a>").click(function(){
				_pt_sp_2.push('setTrackEvent,Goumai,Click,shengdanjinzhuang,0');
			});
			var _a4=$("<a target=\"_blank\" href=\"http://detail.tmall.com/item.htm?spm=a1z10.1.w5003-8315276373.11.skBhZ0&id=42343957105&scene=taobao_shop\" style=\"position:absolute;left:0;top:73.82%;width:100%;height:26.18%;\"></a>").click(function(){
	...
	//upload photo
	var photolayer=$("#photolayer").css("background-image","url('imgpad/step1.jpg')");
	$(".photomc",photolayer).css({"width":"26%","height":"30.5%","left":"36.5%","top":"42.5%"});
	...
	function resetuploadphoto(){
		...
		$("#selectphoto").unbind("load").attr("src","imgpad/transparent.png");
	...
	$("#selectfile").change(function(e){
	 ...
	 function makemessage(txtparam){
        ...
        $("<img  src=\"imgpad/transparent.png\"  />").load(function(){
        	ctx.drawImage(this,0,0,this.width,this.height,0,0,con.width(),con.height());
        	$("<img  src=\"imgpad/messagebg1.png\"  />").load(function(){
		        ...
		        if(appos=="android"){
		        	...
		        	ctx.font="italic bold 2.5em serif";
		        }
	...
	$("#TextContent").css({"top":(_ww*inutpos.line2.bottom/100-textmargin-18),"text-align":"center","left":"12%","width":"75%"}).bind("focus",function(){
		if(appos=="android"){
			wheel=true;
		}
		$(this).val("");
		...
		if(txt.length<10){
			if(appos=="android"){
				...
				tar.css({"font-size":"3em","top":(_ww*inutpos.line2.bottom/100-textmargin-15)});
			}
		}else{
			if(appos=="android"){
				if(window.devicePixelRatio>2){
				...
				tar.css({"font-size":"2.6em","top":(_ww*inutpos.line2.bottom/100-textmargin-10)});
			}
		}
	});
		...
		if(txt.length<6){
			if(appos=="android"){
				if(window.devicePixelRatio>2){
					...
					$("#TextContent").css("font-size","2.5em");
					//$("#TextContent").css("top",(_ww*inutpos.line2.bottom/100-textmargin-12));
				}
			}else{
				//tar.css({"font-size":"1.2em","top":(_ww*inutpos.line2.bottom/100-textmargin-3)});
	...
	treelayer.css("background-image","url('imgpad/step3.jpg')");
	...
	function getFont(message){
		...
		if(customparam.card){
			...
			$("#SpanContent").text(_ctxt);
			$("#SpanFrom").text("From:"+_ftxt);
			$(".completecard").css("background-image","url('imgpad/card.png')")
			makemessage({"t1":_ttxt,"t2":_ctxt,"t3":_ftxt});
		}else{
			$("#SpanTo").text("");
			$("#SpanContent").text("");
			$("#SpanFrom").text("");
			$(".completecard").css("background-image","url('imgpad/carddefault.png')");
		}
	}
	...
	$(".preview",completelayer).bind("tapone",function(){
		...
		$("#hs_1").hide();
		$("#hs_2").hide();
		$("<img id=\"prereturn\" src=\"imgpad/prereturn.png\" />").bind("tapone",function(){
			$("#hs_0").show();
			$("#hs_1").show();
			$("#hs_2").show();
			$(this).remove();
...
var snsparam={
	"img":"http://121.41.115.23/imgpad/sns.jpg",
