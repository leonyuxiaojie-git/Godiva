...
ScrollPic.prototype = {
  ...
  initialize : function(){ //初始化
    ...
    //left
    if(this.arrLeftId){
      $("#"+this.arrLeftId).bind("touchstart",function(){thisTemp.rightMouseDown();}).bind("touchend",function(){thisTemp.rightEnd();})
      //this.alObj = this.$(this.arrLeftId);
      //if(this.alObj){
      	
      	//this.addEvent(this.alObj,"touchend",function(){thisTemp.rightMouseDown()});
    ...
    //right
    if(this.arrRightId){
      $("#"+this.arrRightId).bind("touchstart",function(){thisTemp.leftMouseDown();}).bind("touchend",function(){thisTemp.leftEnd();})
      //this.arObj = this.$(this.arrRightId);
      //if(this.arObj){
      	
      	
      	//this.addEvent(this.alObj,"touchend",function(){thisTemp.leftMouseDown()});
