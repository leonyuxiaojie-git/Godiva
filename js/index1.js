...
D.ready(function(){
	...
	//upload photo
	var photolayer=$("#photolayer").css("background-image","url('img/step1.jpg')");
	...
	if(appos!="android"){
		$("#selectfile").change(function(e){
			$("#onprocessing").show();
			imgtar.unbind().removeAttr("style").load(function(){alert("load1")
				$("#onprocessing").show();
	          	var tar=$(this);
	          	tar.unbind("load").localResizeIMG({
		             ...
		             success: function (result) {
		             	imgtar.removeAttr("style").attr("src",result.base64).load(function(){alert("load2")
		             		$("#onprocessing").show();
	 ...
	 function makemessage(txtparam){
        ...
        $("<img  src=\"img/transparent.png\"  />").load(function(){
        	...
        	$("<img  src=\"img/messagebg1.png\"  />").load(function(){
		        ...
		        if(appos=="android"){
		        	ctx.font="italic bold 3em serif";
		        }else{
		        	ctx.font="italic bold 1.6em serif";
		        }
	...
	$(".returnnskip .skipbtn",cardlayer).bind("tapone",function(){
       ...
       //makemessage({"t1":"Dear Friend","t2":"ABCABCABCABCABCABCABCW","t3":"GODIVA"});
	...
	$(".frontbg",completelayer).css("background-image","url('../img/completec.png')");
...
var snsparam={
	...
	"title":"2014GODIVA＃歌帝梵冬日仙境＃。歌帝梵推出圣诞限量巧克力礼盒，360°转动手机制作你的致臻圣诞贺卡，即刻获赠10元礼惠！拿起手机扫码或直接点击进入体验：http://www.godiva.cn/ultimate2014",
	"desc":"2014GODIVA＃歌帝梵冬日仙境＃。歌帝梵推出圣诞限量巧克力礼盒，360°转动手机制作你的致臻圣诞贺卡，即刻获赠10元礼惠！拿起手机扫码或直接点击进入体验：http://www.godiva.cn/ultimate2014"
}
...
function onBridgeReady() {
		var appId  = '',
        imgUrl = htmlDecode("http://121.41.115.23/img/wechat.jpg"),
